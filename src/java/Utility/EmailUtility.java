...
public static void sendInvoice(String toEmail, String subject,
    ...
    // Room Types Section - FIXED: Sửa logic tính toán và header
    if (bookingRoomTypes != null && !bookingRoomTypes.isEmpty()) {
        ...
        for (BookingRoomType brt : bookingRoomTypes) {
            htmlContent += "<tr>"
                    ...
                    + "<td class='subtotal-text'>" + currencyFormat.format(brt.getPricePerRoom()) + " VND</td>"
                    + "</tr>";
        }
    ...
    // Payment Summary - FIXED: Cải thiện hiển thị
