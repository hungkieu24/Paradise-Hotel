<%-- 
    Document   : revenue
    Created on : Jul 12, 2025, 10:29:16 AM
    Author     : hungk
--%>
                    ...
                    <div class="rooms-container">
                        <div class="tab-buttons">
                            <a href="./revenue" class="tab-button__link">
                                <div class="tab-button active">Revenue</div>
                            </a>
                            <a href="./expense" class="tab-button__link">
                                <div class="tab-button ">Expense</div>
                            </a>
                        </div>
                        <div class="page-actions">
                            <form action="">
                                ...
                                <div class="page-action-wrapper">
                                    ...
                                    <div class="page-action">
                                        <label class="page-actions-label">Source: </label>
                                        <select name="sourceType" class="page-actions-select" required>
                                            <option value="all">All</option>
                                            <c:forEach items="${sourceList}" var="s">
                                                <option value="${s}" ${s == param.sourceType? 'selected' : ''}>
                                                    ${s}
                                                </option>
                                            </c:forEach>
                                        </select>
...
<!--                            <button id="add-branch-btn" class="btn btn-primary js-toggle" toggle-target="#add-modal">
                        ...
                        <div class="rooms-table" id="roomsTable">
                            <p class="cart-info__desc profile__desc">
                                Total Revenue:  <strong> <fmt:formatNumber value="${totalRevenue}" type="currency"/> </strong>
                            </p>
                            <table>
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    <c:forEach items="${revenueList}" var="r" >
                                        <tr class="${r.getCreated_by() == "SYSTEM"? "unchange" : ""} ">
                                            <td>${r.getRevenue_type()}</td>
        ...
        <div id="edit-modal" class="modal hide">
            <div class="modal__content" style="padding: 30px">
                <div class="modal__heading">Edit Revenue</div>
                <form action="revenueEventHandler" method="post" id="edit-form" class="form form-card">
                    ...
                    <div class="form__row">
                        <div class="form__group">
                            <label for="revenueType" class="form__label form-card__label">Revenue Type</label>
                            <div class="form__text-input">
                                <input type="text" name="revenueType" id="revenueType" class="form__input" placeholder="Revenue Type"/>
                            </div>
                    ...
                    <div class="form__row">
                        <div class="form__group">
                            <label for="revenueDate" class="form__label form-card__label">Revenue Date</label>
                            <div class="form__text-input">
                                <input type="date" name="revenueDate" id="revenueDate" class="form__input" placeholder="Revenue Date"/>
                            </div>
                            <p class="form__error"></p>
                        </div>
                        <div class="form__group">
        ...
        <div id="add-modal" class="modal hide">
            <div class="modal__content" style="padding: 30px">
                <div class="modal__heading">Add Revenue</div>
                <form action="revenueEventHandler" method="post" id="add-form" class="form form-card">
                    ...
                    <div class="form__row">
                        <div class="form__group">
                            <label for="revenueType" class="form__label form-card__label">Revenue Type</label>
                            <div class="form__text-input">
                                <input type="text" name="revenueType" id="revenueType-add" class="form__input" placeholder="Revenue Type"/>
                            </div>
                            <p class="form__error"></p>
                        </div>
                    </div>
                    ...
                    <div class="form__row">
                        <div class="form__group">
                            <label for="revenueDate" class="form__label form-card__label">Revenue Date</label>
                            <div class="form__text-input">
                                <input type="date" name="revenueDate" id="revenueDate-add" class="form__input" placeholder="Revenue Date"/>
                            </div>
                            <p class="form__error"></p>
                        </div>
                        <div class="form__group">
        ...
        <div id="delete-modal" class="modal modal--small hide">
            <div class="modal__content">
                ...
                <div class="modal__bottom">
                    ...
                    <form action="revenueEventHandler" method="post">
        ...
        <script>
            function fillModalEdit(ID) {
                fetch("/ParadiseHotel/manager/revenueEventHandler?revenueID=" + ID)
                        .then(res => res.json())
                        .then(data => {
                            if (!data)
                                return;
                            document.getElementById("revenueID").value = data.id;
                            document.getElementById("revenueType").value = data.revenue_type;
                            document.getElementById("revenueDate").value = data.revenue_date;
        ...
        <script>
            Validator({
                ...
                rules: [
                    Validator.isRequired('#revenueType-add', 'Please enter revenue type'),
                    Validator.isRequired('#revenueDate-add', 'Please enter revenue date'),
            ...
            Validator({
                ...
                errorSelector: '.form__error',
                rules: [
                    Validator.isRequired('#revenueType', 'Please enter revenue type'),
                    Validator.isRequired('#revenueDate', 'Please enter revenue date'),
