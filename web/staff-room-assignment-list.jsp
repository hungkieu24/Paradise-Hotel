...
<%
    ...
    Map<Integer, Boolean> fullyAssignedMap = (Map<Integer, Boolean>) request.getAttribute("fullyAssignedMap");
            ...
            <main class="main-content">
                ...
                <div class="content-body">
                    <div class="form-container">
                        ...
                        <!-- Success message from parameter -->
                        <% if (request.getParameter("success") != null && request.getParameter("success").equals("completion")) { %>
                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                            <i class="bi bi-check-circle-fill me-2"></i>
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <a href="<%= contextPath %>/staff-dashboard.jsp" class="btn btn-outline-secondary">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <div class="booking-card">
                                            ...
                                            <div class="booking-footer text-end">
                                                <a href="<%= contextPath %>/staff-room-assignment?action=assign&bookingId=<%= booking.getId() %>" 
