                        ...
                        <table class="room-table">
                            <thead>
                                <tr>
                                    ...
                                    <th><i class="bi bi-hash"></i> NumberRooms</th>
                                    <th><i class="bi bi-moon"></i> Nights</th>
                                    <th><i class="bi bi-currency-dollar"></i> Price per Night</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="quantity-badge"><%= brt.getNumberOfNights() %></span>
                                    </td>
                                    <td class="price-text">
                                        <%= currencyFormat.format(brt.getPricePerNight()) %> VND
                                    </td>
